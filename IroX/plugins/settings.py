...
from IroX.utils.database import (add_nonadmin_chat,
...
from IroX.utils.database.memorydatabase import (
    get_upvote_count,
    is_skipmode,
    set_upvotes,
    skip_off,
...
from IroX.utils.decorators.admins import ActualAdminCB
from IroX.utils.decorators.language import language, languageCB
from IroX.utils.inline.settings import (
    audio_quality_markup, auth_users_markup,
    playmode_users_markup, setting_markup,
    video_quality_markup, vote_mode_markup)
from IroX.utils.inline.start import private_panel
...
async def settings_mar(client, message: Message, _):
    ...
    await message.reply_photo("https://te.legra.ph/file/e8720ce3df1808471b23d.jpg"
        ,caption=_["setting_1"].format(message.chat.title, message.chat.id),
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://te.legra.ph/file/614dc886c1dc0bdb366a1.jpg"),
