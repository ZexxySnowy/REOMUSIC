...
from IroX.utils import help_pannel
from IroX.utils.database import get_lang, is_commanddelete_on
from IroX.utils.decorators.language import (LanguageStart,
                                                  languageCB)
from IroX.utils.inline.help import (help_back_markup,
                                          private_help_panel)
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_sticker("CAACAgUAAxkBAAEDFMZkvHVXiFzz5w7yHJHD76IdRdc_6QACjAoAAlOf4VXd3TmxrqCWHy8E")
